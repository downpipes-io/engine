// Confirms POINT-IN-TIME run resolution + the RTO ESTIMATE: restore resolves a run by timestamp and
// surfaces RTO alongside RPO. In-memory doubles only; no network, no deploy. Run:
...
async function main(): Promise<void> {
  ...
  // =========================================================================================
  {
    ...
    // GET /rto derives a real estimate (1 sample, archive = latest run's 10MB) at low confidence, with
