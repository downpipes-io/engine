...
//
// MEASURED, on this tree, with the exit of every member read from a file:
//   arm            members RED  what it means
//   pristine       0 of 7       baseline
//   drop-sourceip  1 of 7       CONTROL: removing a field FROM the allowlist is caught (12 failures
//                               in validate-audit.ts), so the member set is demonstrably sensitive
//   new-field      0 of 7       THE RESIDUAL: buildEvent stamping a field that neither allowlist
//                               covers slept through ALL SEVEN, the independent oracle included
