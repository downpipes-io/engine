...
// This closes the gap where a solo owner arming dual control is left unable to approve anything, by
// PREVENTION, and raises the last-Owner floor to TWO while dual control is armed. No network, no deploy, no cost.
...
async function main(): Promise<void> {
  ...
  ageRecord(ctx.sched.storage, changeKey(rm3id), "proposedAt", AGE_PAST_DWELL);
