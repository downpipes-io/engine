...
export async function run(): Promise<void> {
  ...
  // is answered with the coarse "forbidden": from their side the link is broken, and nobody can say why. The
  // remedy is unlike every other invite refusal -- they do not need an invite at all, they should just sign in.
  // THE REAL ENTRY POINT: POST /admin/auth/register/begin + /finish, the routes the invite link actually drives.
  {
