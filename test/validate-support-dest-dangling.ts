...
async function main(): Promise<void> {
  ...
  // Regression guard: a fan-out list of all-present ids must NOT fall through to the destinationId branch (a
  // stale destinationId alongside a good destinationIds list must be ignored, because destinationIds
  // supersedes destinationId).
