...
async function main(): Promise<void> {
  ...
  // ============================================================================================
  {
    ...
    // sessionSigningKeyHealth reports whether the STORED session key (which is ALSO
  ...
  // ============================================================================================
  {
    ...
    // The entry carries the TEMPORAL SHAPE (a 14-slot day ring of COUNTS, a firstAt, a
    // capSaturated latch), so a burst and a trickle are not the same row. The assertion this test exists to
