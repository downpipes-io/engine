// Prove the INFRA-1 AUTO-RECONCILE-ON-DETECT (the SAFE auto-heal) end to end, server-side, with in-memory
...
async function main(): Promise<void> {
  ...
  // exactly what a fabricated-filename replay produces once staged). Both apply paths must refuse rather
  // than silently resume/restore from it.
