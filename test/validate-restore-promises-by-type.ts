...
async function main(): Promise<void> {
  ...
  console.log("\nPER-TYPE PROMISES:");
  // secrets. What the reason SAYS is pinned by validate-restore-promise-gaps.ts, which is red today: it is
  // the bare string "restore out of band", naming neither the cause nor a remedy, while three docs pages say
  // it names both. Here we pin only what holds: the record is out of band and is never a planned write.
  ...
  // (the id map) is pinned by validate-restore-promise-gaps.ts, which is red today.
