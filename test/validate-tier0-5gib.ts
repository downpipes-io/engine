// C1 Tier-0 (seal-side memory-boundedness + the single-segment ceiling). Two proofs:
...
//  2. THE CEILING (the restore refuter this cell originally lacked): a value past the single-segment ceiling
...
async function main(): Promise<void> {
  ...
  // CEILING RESTORE REFUTER (the one the first version lacked): the single segment has ceil(TOTAL/64KiB) chunks.
