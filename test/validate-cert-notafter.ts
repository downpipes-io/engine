...
function main(): void {
  ...
  // certValidity returns the notBefore..notAfter window the verify path uses, or null on any
  ...
  }
  {
    ...
    const r = decodeBase64Std("TW Fl\tb\nHN0cm9t");
    ok("decodeBase64Std: strips transport whitespace then decodes", r.ok === true && r.ok && Buffer.from(r.bytes).toString() === "Maelstrom");
  }
  {
