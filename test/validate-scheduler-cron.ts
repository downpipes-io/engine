// SchedulerDO cron / timezone / blackout schedule vectors (engine-test-018-01 split). Proves a
...
// and rejects a malformed one. Behaviour-preserving: same assertions, same order as the original.
