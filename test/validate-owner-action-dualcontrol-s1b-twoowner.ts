...
export async function run(ctx: Ctx): Promise<void> {
  const { sched, OWNER, OWNER2, OPERATOR, call, doFetch, ownerCaller, destConfig, oidcProposal, listDestinations, listIdpConnections, inbox, ownerActionKeyCount, ageOwnerAction } = ctx;
