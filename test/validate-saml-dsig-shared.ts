...
// suite was split out of test/validate-saml-dsig.ts (finding engine-test-016-03: the single main() exceeded
// the 50-line hard flag). The happy-path and red-corpus groups each live in a sibling module and call the
