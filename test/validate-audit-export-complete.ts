// PROOF EXPORT-COMPLETE for the D4 audit validator: the COMPLIANCE EXPORT of the
...
export async function runExportComplete(ctx: Ctx): Promise<void> {
  ...
  // ---- The compliance JSON export is COMPLETE (every retained event, not the newest 500) ----------
  {
    ...
    // The crux of the completeness fix: the response carries MORE than the 500-row cap, i.e. the cap no longer truncates.
