// Source-side fault injector for the chaos harness.
//
// The chaos network-fault proxy can only fault DESTINATION writes; a source READ (a KV/R2/D1 list or
...
// small (tens of keys) -- a chaos run proves behaviour, never scale, and never allocates large buffers.
