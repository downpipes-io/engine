// Prove MID-RECORD RESUMABLE SEAL (PR7): a SINGLE streamed content value too large to seal in one slice
...
async function sealRunToCompletion(
  ...
  let openBuffer: Record<string, unknown>[] = []; // Fix 2a: carry the open-shard buffer across slices (models the DO's persisted batches)
  let slices = 0;
