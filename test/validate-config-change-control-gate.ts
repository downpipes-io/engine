...
// and the owner-only toggle. Split out of validate-config-change-control.ts for size (engine-test-004-01);
// every assertion is byte-identical and runs in the same order against the shared live DO.
