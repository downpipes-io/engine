...
//
// AND THE SECOND HALF, the one this campaign's method asks about. The refusal's first remedy was
...
async function main(): Promise<void> {
  ...
  console.log("-- dose-response: the SAME estate, removed in two orders, over 8 run counts --");
  {
    ...
    // THE DEFECT'S OWN ASSERTION. At the pre-fix tree this is 1 of 8: only the zero dose agreed.
  ...
  // ==============================================================================================
  // 8. REPRODUCTION CONTROL. The SAML_CERTS_MAX edge measured below, re-measured on THIS rig in THIS session,
  //    so a reader can tell this pass's result from this pass's instrument.
  // ==============================================================================================
  console.log("-- reproduction control: the SAML cap edge, re-measured here --");
  {
    ...
    ok("9 are refused (so this rig reproduces a previously-measured bound in this session)", nine.ok === false);
  }
