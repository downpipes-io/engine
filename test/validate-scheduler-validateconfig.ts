// validateConfig authority-boundary unit suite (config-validate.ts); engine-test-018-01 split.
...
// assert the real limits. Behaviour-preserving: same assertions, same order as the original main().
