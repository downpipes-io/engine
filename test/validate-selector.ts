...
// of one-token rewrites of inScope agrees with all ten of them. Measured with a differential oracle that
// computed each mutant beside the real answer across all 489 test/validate-*.ts (over a million inScope
// calls): FOUR mutations changed the answer for not one single call anywhere in the engine suite.
//
