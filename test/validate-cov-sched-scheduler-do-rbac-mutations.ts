...
async function main(): Promise<void> {
  ...
  try {
    ...
    // ===========================================================================================
    {
      ...
      // (8) A time-boxed custom-role grant's expiresAt must gate the CAPABILITY overlay (ASVS V8), not just
      // the built-in role label (the built-in role is already pinned to the viewer floor
