...
async function main(): Promise<void> {
  ...
  // Truly malformed cursors -- non-numeric or non-finite or negative -- are a clear 400 rather than a silent
  // coercion to 0. "1e400" overflows to Infinity: without the finite check it would survive the Worker's
  // clamp then make the DO drop BOTH the cursor and the limit, returning the ENTIRE retained chain
  // unpaginated. The finite check rejects it at the Worker with a 400.
