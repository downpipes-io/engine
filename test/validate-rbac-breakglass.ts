// validate-rbac PROOFs 11, 12 and 13 (finding engine-test-012-M1): the single-use break-glass
// bootstrap latch, retiring the break-glass token everywhere with no redeploy, and the unchanged
