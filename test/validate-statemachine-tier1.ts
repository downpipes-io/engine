// State-machine test: drive the REAL retention prune planner over RANDOM operation sequences and assert
// its invariants hold at EVERY step, over interleavings the example-based validate-prune.ts does not
