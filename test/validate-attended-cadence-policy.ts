...
//
// validate-attended-cadence.ts
// proves the pure oracle; this proves the plumbing that gives it a number to read, driven through the REAL
// admin router and the REAL Durable Object using the shared owner-action harness, so what is asserted is the
