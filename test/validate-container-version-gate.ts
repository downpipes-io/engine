...
// (SPEC 7.1); the magic + version are PLAINTEXT framing checked BEFORE decryption. B7 (cross-version compat)
// is blocked for a CRAFTED archive because the manifest formatVersion is signed -- but the CONTAINER version
// gate (container.ts unframe) is a net-zero-testable pure function, and its three distinct refusals (truncation
// vs bad-magic vs unsupported-version -- "three different fixes") need direct assertions. This asserts them
