...
// ---- ML-29 r2: allowlist-precedence model ----------------------------------------------------
...
function main(): void {
  ...
  // ---- ML-29 r2: allowlist precedence (the regex checks above can't catch this class of bug) ----
  ...
  ok(
    "a real key at the repo root is flagged (the shape of the actual 2026-06-08 incident)",
