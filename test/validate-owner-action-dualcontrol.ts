...
async function main(): Promise<void> {
  ...
  try {
    ...
    // The execute-time single-use guard (second-approve-on-executed) and the live proposer-authority
    // re-check at execute (a proposer demoted from owner cannot have their action run).
