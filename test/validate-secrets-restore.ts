// TC-14 (ENG-M8): Secrets restore path -- SecretsRestoreSink, BoundSecretSink, and the
...
// every such assertion stays green. That is exactly what happened when this file was moved off the old
// literal, and it was caught by mutating the constant and watching three validators stay green.
//
// So the required clauses are written out here, in this file, and checked against the constant's own text
// BEFORE it is used for anything. This is the tripwire; the equality checks below are then the plumbing
...
//
// Dry-run routing (PART 2) -- ENG-M8 fix:
...
//
// Applied restore via runRestore (PART 3) -- ENG-M8 fix:
