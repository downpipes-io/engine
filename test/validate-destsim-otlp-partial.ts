...
// errorMessage }` is populated. Draining the body with `void resp.body?.cancel()` on a 200 and returning a
// clean success would let a partial rejection (a cardinality/quota drop of some datapoints) get recorded
// as a fully-delivered push: the customer's dashboards would silently miss those points. This validator
