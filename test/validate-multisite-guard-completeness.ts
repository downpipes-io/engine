...
//
// IT IS NOT, AND THE MEASUREMENT IS THE REASON THIS FILE EXISTS. Every one of the thirty-five sites below
// was mutated on its own, serially, against the eleven chain members that fail when all thirty-five are
// broken at once. TWELVE OF THE THIRTY-FIVE WERE KILLED BY NOTHING. Then all twelve were deleted together
// and the WHOLE 413-member chain was run: 413 of 413 members ran and every one PASSED, in 781 seconds.
// Twelve safety call sites across five independent families, deleted simultaneously, and the engine's
// entire validate chain was green.
//
...
//
// WHAT IS GRADED HERE, in two halves for the reason the originating pass gives.
