...
async function main(): Promise<void> {
  ...
  //     validator stayed green. MEASURED, and the severity is LOWER than it first looks, which is why it is
  //     written down rather than dressed up: with the nonce pinned to zeroes the ciphertext and the proof
