...
// 16. Entra tid substitution
{
  ...
  // P3 (oidc-entra-multitenant-misconfig): the tenant-not-accepted rejection carries the STABLE code, so the
  // callback layer projects a distinct bounded signal (oidc-tenant-not-accepted) instead of a coarse "issuer".
