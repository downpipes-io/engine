// R-14/F3 (a private bug register, held internally): "prevRunId is on no admin-observable surface, so an auditor cannot
...
async function main(): Promise<void> {
  ...
  // auditor must be able to reconstruct the WHOLE predecessor chain from it alone (F3's actual claim).
  // =========================================================================================
  {
