// Prove the R2 large-object fix ("R2 Tier-1", no archive format change): the REAL R2Source (not a mock
...
async function sealRunToCompletion(
  ...
  // Shard-spanning (Fix 2a): the open shard buffer carries ACROSS slices and is sealed by finaliseRun,
