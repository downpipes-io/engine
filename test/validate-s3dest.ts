...
// emphasis on the production PUT wire shape that had zero coverage (ENG-H7 / ENG-H8): every
...
//
// engine-test-015-M1: this file was one ~1440-line module. It is now a thin ORCHESTRATOR: each
...
//  - the Destination HTTP contract, https enforcement, the ENG-M14 absent-ETag fix, redirect:manual
...
//  - the response-body read caps (ASVS ML-20 / V12.3.1): every destination response read is bounded by
