...
// requests, and a deliberately wrong client secret produced the 401 invalid_client AADSTS7000215 message
// asserted below. This file exists so that all of that stays re-runnable by anyone with no credential, no
// subscription and no third party, which is the only kind of proof that survives the person who built it.
//
...
const SECRET = "SPILLWAY~entra~client~secret~DO~NOT~LEAK~9f3d";
