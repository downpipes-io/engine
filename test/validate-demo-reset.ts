...
// ---- engine-src-037-M1: FAIL-CLOSED at the DO. An UNMARKED instance refuses the reset, wipes nothing ----
...
async function testDOReset(): Promise<void> {
  {
    ...
    // engine-src-037-M1: mark THIS DO as a demo instance first (the router does this on a DEMO_MODE-gated
...
async function testHappyPath(): Promise<void> {
  ...
  // engine-src-037-M1: the router marks the DO as a demo instance before forwarding the reset (a
