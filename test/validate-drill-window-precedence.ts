...
async function main(): Promise<void> {
  ...
  if (segKeys.length < 2) { console.error("PRECONDITION FAILED: the attack needs two distinct segment objects"); verdictReached(bad + 1, checks); process.exit(1); }
