...
//
// The vectors are split across sibling modules (finding engine-test-016-03: the single main() exceeded the
// 50-line hard flag). The shared harness, builders and the signing helper live in
