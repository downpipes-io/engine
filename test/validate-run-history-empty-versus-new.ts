...
async function main(): Promise<void> {
  ...
  // would not be the empty-map case that pass named and the rest of Part 1 would be grading something
  // else entirely.
  ...
  // =========================================================================================
  {
    ...
    // already in the response would be a second answer to one question, which is the shape this campaign
    // keeps finding.
