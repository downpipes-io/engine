...
export async function run(ctx: Ctx): Promise<void> {
  const { OWNER, OWNER2, OPERATOR, call, setGate, doFetch, ownerCaller, ownerActionKeyCount, destConfig, oidcProposal, listDestinations, listIdpConnections, discoveryStatus, ageOwnerAction } = ctx;
