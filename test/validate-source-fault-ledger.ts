...
// ---------------------------------------------------------------------------------------------------
async function g015CfConfigReasons(): Promise<void> {
...
// ---------------------------------------------------------------------------------------------------
async function g042SubPartFaults(): Promise<void> {
...
// ---------------------------------------------------------------------------------------------------
async function g068ItemAttribution(): Promise<void> {
...
// ---------------------------------------------------------------------------------------------------
async function g110ShapeDrift(): Promise<void> {
...
// ---------------------------------------------------------------------------------------------------
async function g144FatalClass(): Promise<void> {
  console.log("run-fatal failures carry a status class + a stage");
  ...
  const l2 = drain("workers-aspects");
  ...
  const l3 = drain("cfconfig-allfailed");
  ...
  // The liveness probe: a deleted resource vs a transient outage are easy to mislabel without a way to check.
  // The error carries the transport class beside the engine's verdict.
  resetSourceFaultLedger();
...
async function main(): Promise<void> {
  await g015CfConfigReasons();
  await g042SubPartFaults();
  await g068ItemAttribution();
  await g110ShapeDrift();
  await g144FatalClass();
