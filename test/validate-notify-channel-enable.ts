// Refuter for NF-1 / G-P1-102: a notification channel's enable/disable toggle, submitted through the edit
...
async function main(): Promise<void> {
  console.log("NF-1 / G-P1-102 refuter: a channel enable/disable toggle PERSISTS and TAKES EFFECT (engine read-back + routing)");
  ...
  // THE FIX (NF-1): an edit submitting enabled:false DISABLES it. Before the fix this read back enabled=true.
  ...
  console.log(failures === 0 ? "\nNF-1 CHANNEL ENABLE-TOGGLE REFUTER PASS" : `\n${failures} FAILURE(S)`);
