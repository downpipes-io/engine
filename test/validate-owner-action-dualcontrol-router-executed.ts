...
export async function run(ctx: Ctx): Promise<void> {
  const { sched, webhookPosts, OWNER, OWNER2, OPERATOR, subjectOf, call, setGate, doFetch, ownerCaller, ownerActionKeyCount, listIdpConnections, inbox, applyOwnerOp, oidcProposal, ageOwnerAction } = ctx;
  ...
  // ===========================================================================================
  // PROOF 3.6 (FOLD 1): the dual-control OFF SWITCH is itself ASYMMETRICALLY gated (+ disarm alert).
  ...
  // ===========================================================================================
  // PROOF 6.5 (FOLD 4): settle gates KEEP, NOT ROLLBACK. The settle route computes the keep/rollback decision
