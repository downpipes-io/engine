...
// wildcard trap (not a hand-built object naming methods, the shape the R-08 fix's own unit test used and
// the review named as insufficient evidence for THIS risk), and passes.
//
...
function teachingMessage(decl: RiskyDeclaration): string {
  return (
    ...
    `  signature that got a Secrets Store binding misclassified as a backup source (R-08).\n` +
