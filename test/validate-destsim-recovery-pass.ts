...
//
// The DO side of the retry is pinned separately by validate-destsim-autoresolve-retry.ts; this pins the
// Worker feedback that drives it. Run: node test/validate-destsim-recovery-pass.ts
