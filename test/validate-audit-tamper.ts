// The audit tamper-evidence + telemetry-correctness cells: net-zero, in-process, no estate, no deploy, no
// spend. This EXTENDS the shipped validate-audit-* suite rather than redoing it: the shipped PROOF 6-9b
// (validate-audit-chain.ts) already drive the alteration, the mid-chain deletion and the seq-gap through the
// product's own verify, and PROOF 1/1b/2/2b (validate-audit-events.ts) already prove the router emissions.
// What this file adds, beyond that:
...
//
// FIDELITY (the design pinned these; this file honours the real mechanism, never a naive framing):
