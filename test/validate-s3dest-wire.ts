// PUT wire-shape vectors for the S3 destination (engine-test-015-M1 split): the production PUT wire
// shape (the heart of ENG-H7 / ENG-H8) and the putStream drain-to-a-single-length-delimited-PUT path.
...
// Part 1: the production PUT wire shape (the heart of ENG-H7 / ENG-H8).
...
// Part 2: putStream produces the SAME length-delimited signed shape as put (ENG-H7). The
