...
const ENGINE_URL = "https://update.downpipes.io/engine-0.9.0.mjs";
const ENGINE_SHA = "a".repeat(96);
const CONSOLE_URL = "https://update.downpipes.io/console-0.9.0.json";
...
async function main(): Promise<void> {
  ...
  const env = { UPDATE_CHANNEL_URL: "https://update.downpipes.io/stable.json", UPDATE_SIGNER_PUBLIC: signerPublic } as never;
