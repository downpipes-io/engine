...
// lifetime of an open screen down to one round trip and would STILL overwrite silently, which is the shape
// this workspace records as a repair that looks done. The read here decides: a moved record REFUSES and
