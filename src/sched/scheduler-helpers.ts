...
// guards for the audit query and the internal notify emit routes. scheduler-do.ts imports these
// under the same names it uses internally.
...
// It also ATTRIBUTES the fault: `downpipeId` names WHICH downpipe's dp:<id> record the failing put was
...
// ---- SCHED housekeeping-health counters -------------------------------------------------
