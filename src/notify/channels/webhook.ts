...
// throws. Returns the best-effort delivery outcome. egressAllowlist (ASVS V13.2.4) is the account's
// current configured allowlist; absent permits every host (screenEgressAllowlist's unset behaviour).
