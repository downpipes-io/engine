...
// check, the signed report and the add-time refusal each used to carry their own copy of the sentence,
// and test/validate-worm-refusal-parity.ts exists because two of those copies had already contradicted
