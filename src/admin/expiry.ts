// Credential and key LIFECYCLE registry (contract section 4): a credential-aware registry.
...
// operator-typed expiry, the registry records what a credential is FOR (purpose +
...
// token's expires_on read once at attach time). The engine NEVER reads an expiry off a secret it
