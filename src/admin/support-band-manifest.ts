...
// since both its own call sites (sealedSupportBundle) and the two out-of-module importers
// (tools/emit-real-support-bundle.ts, test/validate-support.ts) were updated in the same change.
