...
// break-glass credential that expires on a clock fails during the emergency it exists for, and on the estate
// that was measured a clock would have caught nothing anyway, because the residue is recent. Validity is
