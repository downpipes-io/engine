...
// textContent); the InclusiveNamespaces PrefixList reader; the inherited-namespace-context walk; the
...
// parseInclusiveNamespacePrefixes reads the InclusiveNamespaces PrefixList from an exc-c14n# Transform.
