...
// The attack-shape ledger: the void-canon defence firing on a hostile shape that reached the digest
// layer's pre-image is a security event, so noteSamlSignal counts it.
