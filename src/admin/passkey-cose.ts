...
// always thrown, and TAGS it with a CLOSED WebauthnFaultClass. The client-facing response
...
//
// A REFUSED import is tagged key-import-failed. That class is the single most valuable one in the
