...
// PAIRED_ROLLBACK_COPY is the exact, normative one-line copy (design UPDATE-UX-015 §6) the console shows
...
// engineRollbackSatisfiesConsoleFloor (design §6, conditional-bundling rollback) answers whether an ENGINE
