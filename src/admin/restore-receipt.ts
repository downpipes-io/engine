...
export async function makeRestoreReceipt(
  ...
  // meaning and the flag falls out of it. Before the surfaces were on the receipt at all, this expression ran
  // over a record set that contained none of them, which is how an apply that wrote nothing signed clean.
