// The IdP/SSO "test connection" pre-save probe: without it, a misconfigured IdP connection is only
// discovered at the FIRST sign-in, so an operator could save a broken trust root and lock everyone
