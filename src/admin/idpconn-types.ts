...
export interface Oauth2Connection extends IdpConnectionBase {
  ...
  groupsPath?: string;
  pkce: "supported" | "none";
  // The operator-declared RFC-3339 expiry of the confidential client secret; see OidcConnection.
  // Redaction-safe metadata, never the secret value. Observed into the lifecycle registry on create.
  secretExpiresAt?: string;
}

// SAML is the native SAML 2.0 SP: validateIdpConnection routes a kind:"saml" proposal to
