...
// Point-in-time / by-timestamp run resolution. A restore takes a specific runId;
...
export function resolveRunAt(downpipeId: string, ring: RunHistoryEntry[], atMs: number): PointInTimeRun {
  ...
  // COUNTED and reported on the result: a found:false carrying excludedCorruptRuns > 0 means "we found
