// THE LAST-RESORT DISPATCH / SELECTION-PROBE / CORS RECORDERS (support-pack gaps).
//
...
//   The probes inside selectSealDestination know whether it was an expired credential, a deleted
...
/**
 * recordCorsRejection counts ONE request whose Origin failed the CONSOLE_ORIGIN match. It rides the
