// ENGINE KNOB SOURCES for support-pack mode scale-knobs-invisible. The pack carries the
// RESOLVED value of the seal knobs -- but a resolved value cannot answer the commonest tuning ticket:
//
//   "I set SCALE_SEGMENT_TARGET_BYTES / DEST_THROTTLE_ATTEMPTS / SEAL_VERIFY_SAMPLE / REPL_VERIFY_SEGMENTS /
//    SCALE_FANOUT_RANGES and nothing changed."
//
