...
// run yields cleanly instead of dying on them. The two limits that actually
...
// a streamed value with a STABLE ETAG, sealed one window at a time across as many slices as it
...
// KNOB_SOURCES is the CLOSED four-member vocabulary above, hoisted so EVERY env knob the engine
...
// classifyEnvKnob is the ONE shared numeric-knob classifier, mirroring the resolution every knob
...
// scaleKnobSources reports the SOURCE of the seal-shaping SCALE_* knobs. resolveScaleKnobs above
