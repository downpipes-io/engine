// Deterministic release-artefact build (DP-B). Produces the engine bundle the update channel
...
// and VERIFY.md's third-party rebuild claim stands only while that check is green (provii C2:
// prove, then claim).
//
// Usage:
