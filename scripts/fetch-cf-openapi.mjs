...
// found in itself (P1.4b / cfdepth §6): none of those three consumers check the file's AGE, only
...
// That closes both routes named in P1.4b: "delete before fetch" and "fail when it cannot fetch,
